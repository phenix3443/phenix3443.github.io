#+BLOG: panghuli_blog
#+POSTID: 41
#+DATE: [2014-10-22 周三 13:37]
#+CATEGORY:专业知识
#+TAGS:emacs
#+DESCRIPTION:如何使用org2blog 在 WordPress 上发表文章。
#+TITLE:【Emacs】Org2blog
...
* 安装（Installation）
  ...
  #+NAME: install-org2blog
  #+BEGIN_SRC bash :export code :tangle no :syntaxhl title
    git clone http://github.com/punchagan/org2blog.git
  #+END_SRC
  #+HTML:<!--more-->
  加载 org2blog 目录到 load-path，并作相应配置。
  #+NAME: add-to-dot-emacs
...
SyntaxHighlight支持的[[http://en.support.wordpress.com/code/posting-source-code/#configuration-parameters][语言里列表]]。

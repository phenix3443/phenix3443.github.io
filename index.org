...
* 技术能力
  + 掌握使用 C/C++、Golang、Python、Lua 语言，以及对应的 gtest，gocheck 等测试框架。
  + 熟练使用有 Openresty、gin 等技术框架，能够使用火焰图定位问题。
  + 熟练使用 apache ab，wrk 等工具，并利用 tcpcopy、nginx mirror、goreplay 等工具和技术服务进行压测。
  + 熟悉 MySQL，有一定的调优经验。
